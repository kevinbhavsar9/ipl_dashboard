...
export default function MatchCard() {
    return (
        <div className="max-w-sm w-full rounded-xl shadow-md border border-gray-200 overflow-hidden mx-2">
            {/* Top Bar */}
            <div className="bg-blue-100 px-3 py-1 text-xs font-semibold flex justify-between">
                <span className="text-orange-600">STUMPS</span>
                <span className="text-gray-600">Starts 5:00 AM · Only Unofficial TEST · Brisbane</span>
            </div>
...
{/* 
                ...
                <p className="text-xs text-gray-600">
                    Day 3 - IND-A Women lead by <span className="font-semibold">254 runs</span>.
                </p>
